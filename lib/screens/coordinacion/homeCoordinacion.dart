...
class HomeCoordinacionScreen extends StatefulWidget {
  //String user;
  final String nombre;
  final String userType;
  final int userId; // Agregar esta línea
  const HomeCoordinacionScreen(
      {super.key,
  ...
  @override
  State<HomeCoordinacionScreen> createState() => _HomeCoordinacionScreenState();
}

class _HomeCoordinacionScreenState extends State<HomeCoordinacionScreen> {
  ...
  Widget content() {
    String tipoUsuario = widget.userType;
